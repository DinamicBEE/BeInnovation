...
import { FormDataModel } from "./models/common.models";
...
export default function ContactForm() {
    ...
    const [formData, setFormData] = useState<FormDataModel>({} as FormDataModel);
    
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        setIsSubmitting(true);
        
        //TODO: Agregar envio por Email
        await new Promise(resolve => setTimeout(resolve, 1500));
        //TODO: Alertas de validación
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5">
                ...
                <div className="flex justify-end">
                    <Button 
                        ...
                        className="w-full px-8 py-6 bg-[#2d4b8f] hover:bg-[#1f3566] text-white font-semibold rounded-lg transition-all duration-300 hover:scale-105 disabled:opacity-70 disabled:cursor-not-allowed flex items-center gap-2 shadow-md hover:shadow-xl"
                    >
                        {isSubmitting ? (
                        <>
